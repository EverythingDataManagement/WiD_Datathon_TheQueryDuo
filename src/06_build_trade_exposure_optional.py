# FINAL PROJECT NOTE:
# Trade is SUPPORTING/OPTIONAL, not an input to the Crop Fragility Index.
# The uploaded XLSX is >100 MB and may be truncated by Excel's row limit.
# Do not publish conclusions from a truncated matrix. Re-download the FAOSTAT
# normalized/bulk source or pre-filter the export before reproducing trade results.
#
#!/usr/bin/env python3
# =====================================================================
